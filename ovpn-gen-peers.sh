...
mkdir -p /tmp/exports
cd /tmp/exports
docker run -v ${OVPN_DATA}:/etc/openvpn -v /tmp/exports:/exports -i --rm -e DEBUG=1 ghcr.io/eranunplugged/up_openvpn_xor:${OVPN_IMAGE_VERSION} ovpn_getclients ${NUM_USERS}
